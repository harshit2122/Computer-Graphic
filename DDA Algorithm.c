...
{
	type("Harshit Joshi-500068141", 90, -230);
}

void information()
{
	type("Green Color Line for slope between 1 and -1", -25,230);
	type("Blue Color Line for rest of the slopes",-25,210);
} 
...
void DrawLine()
{
	...
	double m = (P[1][1] - P[0][1])/(P[1][0] - P[0][0]); // calculation of slope
	printf("Slope of the line is: %lf\n", m);
...
{ 
	...
	glutCreateWindow("Exp3- DDA Algorithm"); 
	initialize(); 
